...
class JoyMapper(object):
    def __init__(self):
        ...
        # Subscriptions
        self.image_sub = rospy.Subscriber("/pbody/camera_node/image/compressed", CompressedImage, self.img_cb, queue_size=1)
    ...
    def img_cb(self, data):
        ...
        if self.device_work == True and self.count == 2:
            ...
            try:
                ...
                top1 = output.argmax()
                self.omega = (top1 *(2/14.) - 1)*8.3
                print self.omega, time.time()-start
